...
Mode.NORMAL,
"slaves",
new SSHLauncher("'$INSTANCE_IP'", 22, SSHLauncher.lookupSystemCredentials("'$JENKINS_CREDENTIALS_ID'").getId(), null, null, "", "", 60, 3, 15, new NonVerifyingKeyVerificationStrategy()),
